$(function(){
	...
	// CHANGES: Add extra button events
	$('#step1 .encrypt-text').click(function(){
		body.attr('class', 'encrypt-text');
		step(2);
	})

	$('#step1 .decrypt-text').click(function(){
		body.attr('class', 'decrypt-text');
		step(2);
	})
